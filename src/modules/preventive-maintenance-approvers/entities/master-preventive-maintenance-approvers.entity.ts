...
@Entity('master_preventive_maintenance_approvers')
@Index(['masterPreventiveMaintenance', 'user'])
export class MasterPreventiveMaintenanceApprovers extends BaseEntity<MasterPreventiveMaintenanceApprovers> {
  ...
  constructor(entity: Partial<MasterPreventiveMaintenanceApprovers>) {
    super(entity);
