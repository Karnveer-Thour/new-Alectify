...
@Entity('preventive_maintenance_approvers')
@Index(['preventiveMaintenance', 'user'])
export class PreventiveMaintenanceApprovers extends BaseEntity<PreventiveMaintenanceApprovers> {
  ...
  constructor(entity: Partial<PreventiveMaintenanceApprovers>) {
    super(entity);
