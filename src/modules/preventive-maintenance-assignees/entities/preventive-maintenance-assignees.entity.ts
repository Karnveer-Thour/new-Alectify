...
@Entity('preventive_maintenance_assignees')
@Index(['preventiveMaintenance', 'user'])
export class PreventiveMaintenanceAssignees extends BaseEntity<PreventiveMaintenanceAssignees> {
  ...
  constructor(entity: Partial<PreventiveMaintenanceAssignees>) {
    super(entity);
