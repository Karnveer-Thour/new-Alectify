...
export class updateTaskCategoriesEnumMigration1729696847337
  implements MigrationInterface
{
  name = 'updateTaskCategoriesEnumMigration1729696847337';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."preventive_maintenances_task_category_enum" AS ENUM('CORRECTIVE_MAINTENANCE', 'CLEANUP', 'REPLACEMENT', 'OTHERS', 'PREVENTIVE_MAINTENANCE', 'DAMAGE', 'INSPECTION', 'SAFETY', 'TASK')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."master_preventive_maintenances_task_category_enum" AS ENUM('CORRECTIVE_MAINTENANCE', 'CLEANUP', 'REPLACEMENT', 'OTHERS', 'PREVENTIVE_MAINTENANCE', 'DAMAGE', 'INSPECTION', 'SAFETY', 'TASK')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."master_preventive_maintenances_task_category_enum_old" AS ENUM('CLEANUP', 'CORRECTIVE_MAINTENANCE', 'DAMAGE', 'INSPECTION', 'OTHERS', 'PREVENTIVE_MAINTENANCE', 'REPLACEMENT', 'SAFETY')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."preventive_maintenances_task_category_enum_old" AS ENUM('CLEANUP', 'CORRECTIVE_MAINTENANCE', 'DAMAGE', 'INSPECTION', 'OTHERS', 'PREVENTIVE_MAINTENANCE', 'REPLACEMENT', 'SAFETY')`,
    );
    await queryRunner.query(
