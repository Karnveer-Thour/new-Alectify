...
export class updateAllMigration1727930597185 implements MigrationInterface {
  name = 'updateAllMigration1727930597185';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "procedures" ALTER COLUMN "comments" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "procedures" ALTER COLUMN "file_upload" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "incident_reports_documents" DROP CONSTRAINT "FK_c2825bd456049f16fbd8e350f6b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "incident_reports_documents" ALTER COLUMN "incident_report_id" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "incident_reports" ALTER COLUMN "description" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "incident_reports" ALTER COLUMN "status" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "procedure_steps" ADD CONSTRAINT "FK_bd927e7767348c08a2f9ad62580" FOREIGN KEY ("procedure_id") REFERENCES "procedures"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "incident_reports" ADD CONSTRAINT "FK_adb429810e37df76ecab9ba5563" FOREIGN KEY ("team_id") REFERENCES "projects_masterprojectteam"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
...
UNION
 SELECT pmd.id,
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "incident_reports" ALTER COLUMN "status" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "incident_reports" ALTER COLUMN "description" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "incident_reports_documents" ALTER COLUMN "incident_report_id" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "incident_reports_documents" ADD CONSTRAINT "FK_c2825bd456049f16fbd8e350f6b" FOREIGN KEY ("incident_report_id") REFERENCES "incident_reports"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "procedures" ALTER COLUMN "file_upload" SET DEFAULT false`,
    );
    await queryRunner.query(
      `ALTER TABLE "procedures" ALTER COLUMN "comments" SET DEFAULT false`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`CREATE VIEW "documents_view" AS CREATE OR REPLACE VIEW public.documents_view
AS SELECT ttd.id,
    'ASSET'::text AS type,
    null AS work_title,
    tags.project_id AS sub_project_id,
