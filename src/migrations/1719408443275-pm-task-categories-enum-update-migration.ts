...
export class pmTaskCategoriesEnumUpdateMigration1719408443275
  implements MigrationInterface
{
  name = 'pmTaskCategoriesEnumUpdateMigration1719408443275';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."master_preventive_maintenances_task_category_enum" AS ENUM('CORRECTIVE_MAINTENANCE', 'CLEANUP', 'REPLACEMENT', 'OTHERS', 'PREVENTIVE_MAINTENANCE', 'DAMAGE', 'INSPECTION', 'SAFETY')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."preventive_maintenances_task_category_enum" AS ENUM('CORRECTIVE_MAINTENANCE', 'CLEANUP', 'REPLACEMENT', 'OTHERS', 'PREVENTIVE_MAINTENANCE', 'DAMAGE', 'INSPECTION', 'SAFETY')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."preventive_maintenances_task_category_enum_old" AS ENUM('CORRECTIVE_MAINTENANCE', 'CLEANUP', 'REPLACEMENT', 'OTHERS', 'PREVENTIVE_MAINTENANCE')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."master_preventive_maintenances_task_category_enum_old" AS ENUM('CORRECTIVE_MAINTENANCE', 'CLEANUP', 'REPLACEMENT', 'OTHERS', 'PREVENTIVE_MAINTENANCE')`,
    );
    await queryRunner.query(
