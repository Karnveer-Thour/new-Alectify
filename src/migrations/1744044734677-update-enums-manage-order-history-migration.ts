...
export class updateEnumsManageOrderHistoryMigration1744044734677
  implements MigrationInterface
{
  name = 'updateEnumsManageOrderHistoryMigration1744044734677';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."manage_order_histories_quantity_types_enum" AS ENUM('BORROW', 'RESTOCK', 'ORDER', 'PART_UPDATED')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."manage_order_histories_activity_enum" AS ENUM('Items Drawn', 'Items Borrow', 'Order Created', 'Order Updated', 'Items Received', 'Items Received & Order Completed', 'Part Updated')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."manage_order_histories_activity_enum_old" AS ENUM('Items Drawn', 'Items Borrow', 'Order Created', 'Order Updated', 'Items Received', 'Items Received & Order Completed')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."manage_order_histories_quantity_types_enum_old" AS ENUM('BORROW', 'RESTOCK', 'ORDER')`,
    );
    await queryRunner.query(
